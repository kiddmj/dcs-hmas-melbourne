...
-- ===========================================================================================================================
dofile(current_mod_path..'/melbourneRunwaysAndRoutes.lua')		-- Include/insert additional definitions from this file here in the code.  This is the file with the runways and taxi routes specific to this variant of the module.
-- ===========================================================================================================================
...
GT.visual.shape = "hmas_melbourne"								-- name of LODs lua in the Shapes directory.  It needs to be this name with '.lods' appended.
...
GT.ICLS_Glideslope_position	= {-1.5, 18.75, 12.7, 4.5}	-- {x [m], y [m], z [m], glideslope = 3.5 [deg]}
...
GT.Name = "hmas_melbourne"										-- The name of the directory in the "Saved Games\Liveries" directory for additional liveries.
GT.DisplayName = _("HMAS Melbourne (Fixed Wing)")				-- Base model name in game/mission editor
